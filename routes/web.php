...
Route::get('/unactive-account/{customer_id}',[CustomerController::class, 'unactive_account']);
Route::get('/active-account/{customer_id}',[CustomerController::class, 'active_account']);
// Details Product
