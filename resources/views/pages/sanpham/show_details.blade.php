...
<section id="details_items">
    ...
    <div class="product-details"><!--product-details-->
        <div class="col-sm-5">
            <div class="view-product">
                <img src="{{URL::to('/uploads/product/'.$value->product_image)}}" alt="product img 1" id="large-img" />
                <div class="mini-img-list">
                    <img src="../frontend/images/banner10.jpg" alt="product img 4" class="mini-img active" onclick="showImg('../frontend/images/banner10.jpg', 'product img 1', this)">
                    <img src="{{URL::to('/uploads/product/'.$value->product_image)}}" alt="product img 1" class="mini-img" onclick="showImg('{{URL::to('/uploads/product/'.$value->product_image)}}', 'product img 1', this)">
                    <img src="{{URL::to('/uploads/product/'.$value->product_image)}}" alt="product img 2" class="mini-img" onclick="showImg('{{URL::to('/uploads/product/'.$value->product_image)}}', 'product img 1', this)">
                    <img src="{{URL::to('/uploads/product/'.$value->product_image)}}" alt="product img 3" class="mini-img" onclick="showImg('{{URL::to('/uploads/product/'.$value->product_image)}}', 'product img 1', this)">
                </div>
                {{-- <h3>ZOOM</h3> --}}
            </div>
    ...
    <div class="col-sm-7">
        <div class="product-information"><!--/product-information-->
            ...
            <div style="display: flex; justify-content: flex-start;" class="size-color">
                <p class="selected">
