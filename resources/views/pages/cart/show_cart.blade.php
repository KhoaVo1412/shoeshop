                ...
                <tbody>
                    ...
                    <tr>
                        <td class="cart_product">
                            <a href="{{URL::to('/chi-tiet-san-pham/'.$v_content->id)}}"><img
                                    src="{{URL::to('uploads/product/'.$v_content->options->image)}}" width="80"
                                    alt=""></a>
                        </td>
                        <td class="cart_description">
                            <h5><a href="{{URL::to('/chi-tiet-san-pham/'.$v_content->id)}}"
                                    style="color: black">{{$v_content->name}}</a></h5>
                        </td>
                        <td class="cart_size">
                            ...
                            <div class="cart_quantity_button">
                                <form action="{{URL::to('/update-cart-quantity')}}" method="POST">
                                    ...
                                    <input class="cart_quantity_input" type="number" name="cart_quantity"
                                        value="{{$v_content->qty}}" style="width: 40%">
                ...
                <td>
                    <form action="{{ url('/check-coupon') }}" method="POST">
                        ...
                        <input type="submit" name="check_coupon" class="btn btn-default check_coupon"
                            value="Xác nhận mã giảm giá" style="background-color: #ffcb87;margin:10px 0px 10px 0px">
                    </form>
                        ...
                        <ul>
                            ...
                            <li>
                                ...
                                <p>
                                    ...
                                    echo '
                                <p>
                            <li>Tổng giảm:'.number_format($total_coupon,0,',','.').' VND</li>
                            </p>';
                            ...
                            <p>
                                <li>Số tiền cần phải thanh toán: <span>{{ number_format($total_end,0,',','.')}}
                                        VND</span></li>
                            </p>
                            <input type="hidden" value="{{$total_coupon}}" name="giam_gia">
                            <input type="hidden" value="{{$total_end}}" name="tien_phai_tra">
